...
\section{ОПЫТ}
{\customcventry{Окт 2023 - Настоящее время (2 года)}{Менеджер по маркетингу и продукту}{Фирма 1С}{Москва, Россия}{}
{\begin{itemize}
\item Определял приоритеты развития PaaS-сервиса (20K+ пользователей) на основе данных (Retention, Churn, MAU ...).
