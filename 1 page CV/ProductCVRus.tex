...
\section{ОПЫТ}
{\customcventry{Окт 2023 - Настоящее время (1 год 11 мес)}{Менеджер по маркетингу и продукту}{Фирма 1С}{Москва, Россия}{}
{\begin{itemize}
\item Определял приоритеты развития PaaS-сервиса (5K+ пользователей) на основе данных (Retention, Churn Rate, MAU ...).
