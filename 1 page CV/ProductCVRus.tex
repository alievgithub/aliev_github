...
\section{О СЕБЕ}
\begin{minipage}{\maincolumnwidth}
\small Ориентированный на результат продуктовый менеджер с опытом разработки облачных продуктов в IT (PaaS и SaaS) и взаимодействия с пользователями. Занимался увеличением таких метрик Retention, MAU, Churn Rate и общей удовлетворенности пользователей. Также имею опыт маркетинге, стратегическом и исследовательском консалтинге.
\end{minipage}

\section{ОПЫТ}
{\customcventry{Окт 2023 - Настоящее время (1 год 7 мес)}{Менеджер по маркетингу и продукту}{Фирма 1С}{Москва, Россия}{}
{\begin{itemize}
\item Управлял дорожной картой и формировал задачи для PaaS-сервиса с охватом более 3 тыс. активных* пользователей.
\item Взаимодействовал с клиентами для сбора обратной связи, занимался консультацией по проектам 13 ключевых клиентов.
\item Выступал на 2 конференциях по стратегиям монетизации сервисов, на которых было привлечено более 15 партнеров.
...
\item Управлял проектами и разработал стратегии по прогнозированию рынков продовольствия и энергетики до 2035 года.
\item Занимался мониторингом интернета, СМИ, публикаций, нормативных документов для более чем 10 темам устойчивого и социально-экономического развития по предметным запросам руководства для 2-х проектов.
\end{itemize}
}
}
...
{\begin{itemize}
\item Вел 4 собственных проекта по оценке эффективности маркетинговых кампаний в сфере FMCG, используя регрессию.
